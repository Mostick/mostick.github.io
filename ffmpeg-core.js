    ...
    return function (createFFmpegCore = {}) {
        ...
        function getEnvStrings() {
            if (!getEnvStrings.strings) {
                var lang =
                    ((typeof navigator == 'object' && navigator.languages && navigator.languages[0]) || 'C').replace('-', '_') + '.UTF-8';
                var env = {
                    USER: 'web_user',
                    LOGNAME: 'web_user',
                    PATH: '/',
        ...
        var _ff_h264_cabac_tables = (Module['_ff_h264_cabac_tables'] = 1534124);
        var ___start_em_js = (Module['___start_em_js'] = 6051837);
        var ___stop_em_js = (Module['___stop_em_js'] = 6052014);
